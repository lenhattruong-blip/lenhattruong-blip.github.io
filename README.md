# Le Nhat Truong — Engineering Portfolio

Personal portfolio at https://lntruong.is-a.dev, hosted on GitHub Pages.

Static HTML, CSS and JavaScript. No build step or backend. The default content is English, with Vietnamese translation and a light/dark preference saved locally in the visitor's browser. The English CV remains labelled as English in both languages.
...
Google Fonts is the only external presentation dependency; local system fonts provide a fallback. No third-party JavaScript is required.
